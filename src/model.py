...
class REVIEWDI(nn.Module):
    def __init__(self, vocab_size, sos_idx, eos_idx, pad_idx, unk_idx, args, device):
        super().__init__()
        ...
        self.m_output2vocab = nn.Linear(self.m_hidden_size*(2 if self.m_bidirectional else 1), vocab_size)

        self.m_latent2RRe = nn.Linear(self.m_latent_size, vocab_size)
        self.m_latent2ARe = nn.Linear(self.m_latent_size, vocab_size)
    ...
    def forward(self, input_sequence, length):
        ...
        return logp, z_mean, z_logv, z, s_mean, s_logv, s, ARe_pred, RRe_pred
